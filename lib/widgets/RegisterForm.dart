...
class _RegisterFormState extends State<RegisterForm> {
  ...
  Widget build(BuildContext context) {
    ...
    return Form(
        ...
        child: ListView(
          children: <Widget>[
            TextFieldWidgetWithValidation('ชื่อร้าน', _shopNameController),
            TextFieldWidgetWithValidation("ชื่อเจ้าของร้าน", _ownerNameController),
            number,
            // EmailField(_emailController),
            TextFieldWidgetWithValidation(
                'รายละเอียดร้านค้า', _descriptionController),
            ItemImagePicker(
              notifyParent: setUrl,
              fromEdit: false,
            ),
